...
//Member Methods
void player::printCar(WINDOW*& window)
{
    //Draw Car
...
void player::clearPlayer(WINDOW*& window)
{
...
void player::haveKid(WINDOW* window, char kidGender)
{
...
void player::twins(WINDOW* interfaceWindow)
{
    int interfacePrintX = 77;
    int interfacePrintY = 5;
...
void player::applyPayout(int payout)
{
    money = money + payout;
}

void player::loseJob(WINDOW*& interfaceWindow, std::vector<career>& jobs, std::vector<career>& careers, bool userOrNot)
{
...
void player::taxRefund()
{
    money = money + job.taxes;
}

void player::spinToWin(WINDOW*& interfaceWindow, WINDOW*& spinnerWindow, bool userOrNot)
{
    int interfacePrintX = 77;
    int interfacePrintY = 5;
    bool goodInput = false;
...
void player::spinForMoney(WINDOW*& spinnerWindow)
{
    int spin = spinSpinner(spinnerWindow);
    money = money + (spin * 10000);
}

void player::lawsuit(player*& opponent1, player*& opponent2)
{
...
void player::fivePerKid()
{
    money = money - (kidCount * 5000);
}

void player::fiftyPerKid()
{
    money = money - (kidCount * 50000);
}

void player::twentyFivePlusFivePerKid()
{
    money = money - 25000 - (kidCount * 5000);
}

void player::dayCare(player*& opponent1, player*& opponent2)
{
...
void player::returnToSchool(bool userOrNot)
{
    if(userOrNot == true)
    {
        bool goodInput = false;
...
void player::pathOfLife(bool userOrNot)
{
    if(userOrNot == true)
    {
        bool goodInput = false;
...
void player::riskyOrSafe(bool userOrNot)
{
    if(userOrNot == true)
    {
        bool goodInput = false;
...
void player::chooseCareerOrPayRaise(WINDOW*& interfaceWindow, bool userOrNot, std::vector<career> collegeCareers)
{
    if(userOrNot == true)
    {
        bool goodInput = false;
...
void player::setLocation(tile* location)
{
...
void player::setJob(career job)
{
    this -> job = job;
}

void player::setHome(house home)
{
    this -> home = home;
}
...
void player::addToLifeCards()
{
    lifeCards++;
}

void player::setX(int xCoord)
{
    this -> xCoord = xCoord;
}

void player::setY(int yCoord)
{
    this -> yCoord = yCoord;
}

void player::setInterfaceX(int interfaceX)
{
    this -> interfaceX = interfaceX;
}

void player::setInterfaceY(int interfaceY)
{
    this -> interfaceY = interfaceY;
}

void player::setSpouse(char spouseGender)
{
    spouse = spouseGender;
}
...
void player::setKid1(char gender)
{
    kid1 = gender;
}

void player::setKid2(char gender)
{
    kid2 = gender;
}

void player::setKid3(char gender)
{
    kid3 = gender;
}

void player::setKid4(char gender)
{
    kid4 = gender;
}
...
house player::getHome()
{
    return home;
}

bool player::getMissTurn()
{
    return missTurn;
}
...
int player::getInterfaceXCoord()
{
    return interfaceX;
}

int player::getInterfaceYCoord()
{
    return interfaceY;
}

char player::getSpouse()
{
    return spouse;
}

int player::getKidCount()
{
    return kidCount;
}
