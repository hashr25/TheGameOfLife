...
public:
    ...
    *//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //Member Methods
    void createTile(string tileInfo)
    {
        setInfo(tileInfo);
    }
    ...
    *//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void setTilePurpose(tileFunction tilePurpose) { this -> tilePurpose = tilePurpose; }
    void setXOne(int xOne) { this -> xOne = xOne; }
    void setYOne(int yOne) { this -> yOne = yOne; }
    void setXTwo(int xTwo) { this -> xTwo = xTwo; }
    void setYTwo(int yTwo) { this -> yTwo = yTwo; }
    void setXThree(int xThree) { this -> xThree = xThree; }
    void setYThree(int yThree) { this -> yThree = yThree; }
    void setNext(tile* next) { this -> next = next; }
    void setSplit(tile* split) { this -> split = split; }

    string getInfo() { return info; }
    int getPayout() { return payout; }
    tileFunction getTilePurpose() { return tilePurpose; }
    int getXOne() { return xOne; }
    int getYOne() { return yOne; }
    int getXTwo() { return xTwo; }
    int getYTwo() { return yTwo; }
    int getXThree() { return xThree; }
    int getYThree() { return yThree; }
    tile* getNext() { return next; }
    tile* getSplit() { return split; }
